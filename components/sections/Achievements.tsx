      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {content.achievements.map((a) => (
            <div key={a.id} className="relative p-4 rounded-xl glass group">
              ...
              <div className="relative flex items-center gap-4">
                {a.imageUrl && (
                  <Image src={a.imageUrl} alt={a.title} width={64} height={64} className="rounded-md border border-white/10" />
                )}
                <div>
